  ...
  return (
    <div className="fixed top-0 left-0 w-full z-[100] px-4 md:px-6 py-4 md:py-6 pointer-events-none">
      <header className={`mx-auto max-w-5xl transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] pointer-events-auto border border-transparent flex items-center justify-between ${
        ...
        ? 'bg-black/60 backdrop-blur-2xl py-3 px-6 rounded-full border-white/10 shadow-[0_8px_32px_rgba(37,99,235,0.2)] translate-y-2' 
      ...
      {/* Mobile Menu Overlay */}
      <div className={`fixed inset-0 bg-[#02040a]/98 backdrop-blur-3xl z-[110] transition-all duration-500 ease-in-out flex flex-col p-8 md:p-12 pointer-events-auto ${
        ...
        <div className="flex-grow flex flex-col justify-center gap-10">
          {navLinks.map((link) => (
            <button 
              ...
              className={`text-5xl xs:text-6xl font-surge tracking-tighter text-left transition-all duration-300 transform ${
                currentPage === link.id ? 'text-blue-500 translate-x-2' : 'text-zinc-600 hover:text-white'
              }`}
            >
              {link.label}
            </button>
          ...
          <button 
            ...
            className={`text-left text-5xl xs:text-6xl font-surge tracking-tighter transition-all duration-300 ${
              currentPage === 'waitlist' ? 'text-blue-500 translate-x-2' : 'text-zinc-600 hover:text-white'
            }`}
          >
            Waitlist
          </button>
        ...
        <div className="mt-auto">
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-600 mb-4">Unified African Commerce</p>
          <div className="flex gap-6">
            <Linkedin size={20} className="text-zinc-600 hover:text-white transition-colors cursor-pointer" />
            <Mail size={20} className="text-zinc-600 hover:text-white transition-colors cursor-pointer" />
          </div>
        </div>
      </div>
    </div>
...
const HomePage = ({ setPage }: { setPage: (p: Page) => void }) => (
  <section className="relative min-h-screen flex flex-col items-center justify-center pt-32 pb-20 px-6 text-center overflow-hidden">
    ...
    <div className="relative z-10 flex flex-col items-center max-w-7xl mx-auto">
      ...
      <p className="text-zinc-400 text-base md:text-2xl max-w-2xl mx-auto font-medium leading-relaxed mb-12 md:mb-16 px-4 animate-in fade-in duration-1000 delay-200">
    ...
    <section className="pt-32 md:pt-48 pb-32 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-5xl mx-auto mb-24 md:mb-40">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 text-zinc-400 text-lg md:text-xl font-medium leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-24 md:mb-40">
          <div className="p-8 md:p-12 glass rounded-[2.5rem] md:rounded-[3rem] border-white/5 group hover:border-blue-500/20 transition-all duration-500">
             ...
             <ul className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-600 space-y-3">
        ...
        <div className="mb-24 md:mb-48 border-t border-white/5 pt-24 md:pt-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
            <div>
              ...
              <p className="text-zinc-500 text-lg md:text-xl mb-10 md:mb-12 font-medium leading-relaxed">Infrastructure fragmentation is a hidden tax. Every disconnected tool costs you 15-30% in potential scale.</p>
            ...
            <div className="grid grid-cols-1 gap-4 md:gap-6">
              <div className="p-8 md:p-10 glass rounded-[2.5rem] md:rounded-[3rem] flex flex-col sm:flex-row items-start sm:items-center gap-6 md:gap-10 group border-l-4 border-l-blue-600">
                ...
                <div>
                  ...
                  <p className="text-zinc-600 text-[8px] md:text-[9px] mt-1 font-bold uppercase">Capital Recovered</p>
                </div>
              </div>
              <div className="p-8 md:p-10 glass rounded-[2.5rem] md:rounded-[3rem] flex flex-col sm:flex-row items-start sm:items-center gap-6 md:gap-10 group border-l-4 border-l-blue-400">
                ...
                <div>
                  ...
                  <p className="text-zinc-600 text-[8px] md:text-[9px] mt-1 font-bold uppercase">Estimated Annual Impact</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-24 gap-x-12 max-w-6xl mx-auto">
            {foundingTeam.map((member, i) => (
              <div key={i} className="group relative text-left border-l border-white/5 pl-8 hover:border-blue-500/40 transition-all duration-500">
                <div className="mb-6 h-12 flex items-center text-zinc-800 group-hover:text-blue-500 transition-colors duration-500">
                  <div className="flex items-center gap-4">
                    {member.icon || <User size={24} strokeWidth={1} />}
                    <div className="h-[1px] w-8 bg-zinc-800 group-hover:bg-blue-500 group-hover:w-12 transition-all duration-500"></div>
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <p className="text-zinc-500 text-[9px] font-black uppercase tracking-[0.2em] opacity-60 group-hover:opacity-100 transition-opacity">
                    {member.role}
                  </p>
                </div>
              </div>
    ...
    <section className="pt-32 md:pt-48 pb-32 px-6" id="contact-section">
      <div className="max-w-7xl mx-auto">
        <div className="max-w-4xl mx-auto text-center pt-24 md:pt-32">
          ...
          <p className="text-zinc-500 text-lg md:text-2xl mb-12 font-medium">Contribute to our pre-seed mission and help us build the future of African commerce.</p>
          
          <div className="mb-10 text-zinc-600 text-[10px] font-black uppercase tracking-[0.4em]">Direct Correspondence</div>
      ...
      <div className="max-w-6xl mx-auto">
        {status !== 'success' ? (
          <>
            ...
            <p className="text-zinc-500 text-lg md:text-2xl mb-12 md:mb-16 max-w-3xl mx-auto font-medium leading-relaxed">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 md:gap-6 max-w-2xl mx-auto p-2 glass rounded-2xl md:rounded-full border-white/10">
              <input 
                ...
                className="flex-grow bg-transparent py-5 md:py-6 px-8 md:px-10 focus:outline-none text-white font-medium text-lg placeholder:text-zinc-700"
                value={email}
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 md:gap-16 mb-20 md:mb-24">
          <div className="max-w-md mx-auto md:mx-0">
            ...
            <p className="text-zinc-500 text-lg font-medium leading-relaxed mb-8 md:mb-10">
        ...
        <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 text-[9px] md:text-[10px] font-black text-white/10 tracking-[0.4em] uppercase">
          <p className="text-center md:text-left">© 2024 Marvex Technologies Inc. • Built for the Pan-African Future.</p>
        </div>
      </div>
    </footer>
  );
